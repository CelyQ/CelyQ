...
I'm a seasoned full-stack web developer with 5+ years of experience in TypeScript, Node.js, Nest.js, Express, Next.js, React, Redux, Docker, SQL and NoSQL databases, and commonly used Cloud Providers. I'm dedicated to staying up-to-date with the latest industry trends and technologies to provide the best possible solutions for my clients.
